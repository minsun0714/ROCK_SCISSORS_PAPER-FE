...
function BattleRoom() {
  ...
  shouldCancelOnLeaveRef.current =
    !cancelledManuallyRef.current && isLobby && role === "creator" && requestId != null && !rejected;
  ...
  const handleCancelBattle = () => {
    ...
    // Prevent cleanup effect from also calling cancel on unmount
